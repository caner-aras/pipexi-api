...
namespace Pipexi.Application.Features.Conversations.Commands.ClearConversation;

public sealed record ClearConversationCommand(Guid ConversationId)
    : ICommand<Result<bool>>
{
    public sealed class Handler(
        ...
        : IRequestHandler<ClearConversationCommand, Result<bool>>
    {
        public async Task<Result<bool>> Handle(
            ClearConversationCommand request,
