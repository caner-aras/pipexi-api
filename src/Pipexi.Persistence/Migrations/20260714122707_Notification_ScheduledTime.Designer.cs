...
namespace Workforce.Persistence.Migrations
{
    ...
    [Migration("20260714122707_Notification_ScheduledTime")]
    partial class Notification_ScheduledTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workforce.Domain.Entities.LocationWorkingHour", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Workforce.Domain.Entities.ShiftRequiredFormTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Workforce.Domain.Entities.TeamMemberDayOff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Workforce.Domain.Entities.TaskComment", b =>
                {
                    b.HasOne("Workforce.Domain.Entities.TeamMember", null)
                        .WithMany()
